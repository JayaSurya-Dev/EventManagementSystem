...
{		
	...
	move_uploaded_file($_FILES["file"]["tmp_name"],"Staff/" . $_FILES["file"]["name"]);
	$location="Staff/" . $_FILES["file"]["name"];
	...
	$from = "Alumni Management Service";
	$headers = "From:" . $from;
	mail($to,$subject,$message,$headers);
	
	$query="insert into staff(lid,password,name,gender,age,destin,mstatus,course,year,depart,email,pno,address,photos,rdate,gname) values('".$rno."','".$password."','".$name."','".$gender."','".$age."','".$dnation."','".$mstatus."','".$course."','".$year."','".$dname."','".$email."','".$pno."','".$address."','".$location."','".$rdate."','Group')";
	$reg=mysql_query($query);
	
	if($reg)
	{
		header("location:Staff.php?v='yes'");		
	}
}
?>
...
<div id="tooplate_wrapper">
  ...
  <tr>
    <td width="289" height="42"><div align="right" id="r">Staff ID:</div></td>
    <td width="300">
