...
{		
	...
	$query="insert into events(sid,sname,etype,title,msg,image,file,pdate) values('".$sid."','".$sname."','".$etype."','".$title."','".$msg."','".$eimage."','".$efile."','".$pdate."')";
	$reg=mysql_query($query);
	
	if($reg)
	{
		header("location:Student Home.php?v='yes'");		
	}
}
?>
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div class="shome">
        <form action="Events Post.php" method="post" enctype="multipart/form-data" onsubmit="return check(this);">
  ...
  <tr>
    ...
    <td>
      <input type="text" name="title" id="etxt" /></td>
  </tr>
  <tr>
    <td><div align="right">Message:</div></td>
    <td><textarea name="msg" cols="" rows="" id="emsg"></textarea></td>
  </tr>
  <tr>
