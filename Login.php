...
if($_REQUEST['v']!=null)
{
	 echo"<script>alert('Students Register Successfully')</script>";
}
?>
<?php
error_reporting(error_reporting() & ~E_NOTICE);
...
{
	$cmd="select * from students where rno='".$_POST['rno']."'";
	$cmd1=mysql_query($cmd);
	while($rs=mysql_fetch_array($cmd1))
	{
		if(($rs['rno']==$_POST['rno']) && ($rs['password']==$_POST['password']))
		{
			$_SESSION['s1']=$rs['sid'];
			$_SESSION['s2']=$rs['name'];
...
<div id="tooplate_wrapper">
  ...
  <tr>
    <td width="113"><div align="right" id="r1">Reg No:</div></td>
    <td width="175">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><div align="center" id="r1"><a href="Register.php">New User Click Here...</a></div></td>
  </tr>
</table>
