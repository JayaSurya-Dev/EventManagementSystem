...
{		
	...
	$query="insert into events(sid,sname,etype,title,msg,image,file,pdate,gname) values('".$sid."','".$sname."','".$etype."','".$title."','".$msg."','".$eimage."','".$efile."','".$pdate."','".$gname."')";
	$reg=mysql_query($query);
	
	if($reg)
	{
		header("location:Group Events.php?v='yes'");		
	}
}
?>
