...
{
	$cmd="select * from admin where lid='".$_POST['lid']."'";
	$cmd1=mysql_query($cmd);
	while($rs=mysql_fetch_array($cmd1))
	{
		if(($rs['lid']==$_POST['lid']) && ($rs['lpass']==$_POST['lpass']))
		{			
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <form action="" method="post" onsubmit="return check(this);">
        	<table width="298" height="133" border="0">
  <tr>
    <td width="113"><div align="right" id="r1">Login ID:</div></td>
    <td width="175">
      <input type="text" name="lid" id="txt1" /></td>
  </tr>
  <tr>
    <td><div align="right" id="r1">Password:</div></td>
    <td>
      <input type="password" name="lpass" id="txt1" /></td>
  </tr>
  <tr>
