...
if($_REQUEST['v2']!=null)
	{
		 echo"<script>alert('Events Update Successfully')</script>";
	}
?>
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div class="shome">
        <div align="center" id="tname"><marquee direction="right">****** Events List *****</marquee></div>        
        	<div id="eupdate">
  ...
  <?php
	...
	$sid=$_SESSION['s1'];
	$result=mysql_query("select * from  events where sid='".$sid."'");
		while($rec = mysql_fetch_assoc($result))
		{
			 ...
			 echo $rec['pdate'];
			 print"</td><td>";	 
			 echo "<a href='Events Update1.php?e1=".$rec['eid']." &e2=".$rec['etype']." &e3=".$rec['title']." &e4=".$rec['msg']."'>Update Events</a>";			 		 		 		
	 		 print"</td>";
			 print"</font></tr>";   
		}
  ?>   
