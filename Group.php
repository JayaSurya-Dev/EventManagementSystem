...
{
	$cmd="select * from students where gname='".$_POST['gname']."'";
	$cmd1=mysql_query($cmd);
	while($rs=mysql_fetch_array($cmd1))
	{
		if(($rs['gname']==$_POST['gname']) && ($rs['password']==$_POST['password']))
		{
			$_SESSION['s1']=$rs['sid'];
			$_SESSION['s2']=$rs['name'];
			...
			$_SESSION['s8']=$rs['gname'];
				
			header("location:Group Events.php");
		}
		else 
		{
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <form action="" method="post" onsubmit="return check(this);">
        	<table width="298" height="134" border="0">
  <tr>
    <td width="113"><div align="right" id="r1">Group Name:</div></td>
    <td width="175">
      <input type="text" name="gname" id="txt1" /></td>
  </tr>
  <tr>
